...
class NepaliCalendar extends _Calendars.BaseCalendar {
  ...
  toJD(yearOrDate, month, day) {
    ...
    var gregorianCalendar = _Calendars.default.instance('gregorian'); // We will add all the days that went by since the 1st January and then we can get the Gregorian Date
  ...
  fromJD(jd) {
    var gregorianCalendar = _Calendars.default.instance('gregorian');
