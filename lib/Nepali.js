...
class NepaliCalendar extends _Calendars.CalendarBase {
  ...
  toJD(yearOrDate, month, day) {
    ...
    var gregorianYear = y - (m > 9 || m === 9 && d >= NEPALI_CALENDAR_DATA[y][0] ? 56 : 57);
  ...
  fromJD(jd) {
    ...
    var dayOfFirstJanInPaush = NEPALI_CALENDAR_DATA[nepaliYear][0];
    ...
    var daysSinceJanFirstToEndOfNepaliMonth = NEPALI_CALENDAR_DATA[nepaliYear][nepaliMonth] - dayOfFirstJanInPaush + 1;
