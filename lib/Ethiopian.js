...
class EthiopianCalendar extends _Calendars.BaseCalendar {
  // Localisations for the plugin.
  // Entries are objects indexed by the language code ('' being the default US/English). */
  constructor() {
    var language = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    super('Ethiopian', 1724220.5, EthiopianCalendar.localisations[language] || EthiopianCalendar.localisations[''], [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 5], 13);
