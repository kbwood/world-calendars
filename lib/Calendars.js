...
class BaseCalendar {
  ...
  constructor(name, jdEpoch, local, daysPerMonth) {
    var hasYearZero = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var minMonth = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 1;
    var firstMonth = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 1;
    var minDay = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 1;
