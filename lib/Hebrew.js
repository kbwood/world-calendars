...
class HebrewCalendar extends _Calendars.BaseCalendar {
  // Localisations for the plugin.
  // Entries are objects indexed by the language code ('' being the default US/English). */
  constructor() {
    var language = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    super('Hebrew', 347995.5, HebrewCalendar.localisations[language] || HebrewCalendar.localisations[''], [30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 29], 12, false, 1, 7, 1);
